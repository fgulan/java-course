...
public class TokenString extends Token {
	 ...
	 * @param value Value of string token.
	 */
	...
	/**
	 * Returns formatted textual representation of string token 
	 * with added '"' at the beginning and at the end of string.
	 * @return Formatted textual representation of string token.
	 */
	@Override
	public String asText() {
		String tmpString = value.replace("\\", "\\\\").replace("\"", "\\\"").replace("\n","\\n").replace("\t","\\t").replace("\r","\\r");
		return "\"" +tmpString + "\"";
	}
}
