...
/**
 * ValueWrapper class represents wrapper for any type of an object. This class
 * implements several operation for performing over given object if they are
 * instances of {@link Integer}, {@link Double} or {@link String} (If given
 * string is also double or integer number).
 * 
 * @author Filip Gulan
 * @version 1.0
 *
...
public class ValueWrapper {
    ...
    /**
     * Constructor for ValueWrapper. Creates value wrapper which stores given
     * object.
     * 
     * @param value
     *            Object to store.
    ...
    /**
     * Checks if given and stored value are instance of {@link Integer},
     * {@link Double}, {@link String} or {@code null}.
     * 
     * @param value2
     *            Value to check.
     */
    private void checkArguments(Object value2) {
        if (!(value instanceof Integer || value instanceof Double
                || value instanceof String || value == null || !(value2 instanceof Integer
                || value2 instanceof Double || value2 instanceof String || value2 == null))) {
     ...
     * @param value
     *            String to check.
     * @return {@code true} if given string is integer number, {@code false}
     *         otherwise.
     */
    ...
    private void calculate(Object value2, IOperator operation) {
        ...
        result = operation.calculate(number1.doubleValue(),
                number2.doubleValue());
     ...
     * @return 0 if given number and currently stored number are equal; integer
     *         less than zero if currently stored value is smaller than
     *         argument; integer greater than zero if currently stored value is
