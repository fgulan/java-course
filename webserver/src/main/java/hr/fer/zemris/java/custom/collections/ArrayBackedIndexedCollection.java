...
public class ArrayBackedIndexedCollection {
    ...
    /**
     * Creates a new collection with capacity set to
     * <code>initialCapacity</code>.
     * 
     * @param initialCapacity
     *            Initial capacity of collection.
     * @throws IllegalArgumentException
     *             Capacity of collection must be greater than 0.
     */
     ...
     *             The index must be greater than or equal to the 0 or less than
     *             to the number of elements in collection.
     */
    public Object get(int index) {
        if (index < 0 || index >= size) {
            throw new IndexOutOfBoundsException(
                    "The index must be greater than or equal to the 0 or "
                            + "less than to the number of elements in collection.");
        }
    ...
    public void remove(int index) {
        if (index < 0 || index >= size) {
            throw new IndexOutOfBoundsException(
                    "The index must be greater than or equal to the 0 or less "
                            + "than to the number of elements in collection.");
        }
     ...
     * @throws IndexOutOfBoundsException
     *             The position must be greater than or equal to the 0 or less
     *             than or equal to the number of elements in collection.
     */
