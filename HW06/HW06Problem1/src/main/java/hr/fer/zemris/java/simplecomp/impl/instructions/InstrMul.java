...
/**
 * InstrAdd represents assembler instruction for multiplying two numbers.
 * 
 * @author Filip Gulan
 * @version 1.0
 */
public class InstrMul implements Instruction {
	...
	/**
	 * Constructor for InstrMul class. Creates a new instruction for 
	 * multiplying two numbers. It accepts list with three registers
	 * where first register is result register, and other two are 
	 * integer numbers to multiply. 
