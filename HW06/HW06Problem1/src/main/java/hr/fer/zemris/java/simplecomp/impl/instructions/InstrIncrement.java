...
public class InstrIncrement implements Instruction {
	...
	/**
	 * Constructor for InstrIncrement class. Creates a new instruction for 
	 * incrementing given number. It accepts list with one register
	 * where is integer number to increment. 
