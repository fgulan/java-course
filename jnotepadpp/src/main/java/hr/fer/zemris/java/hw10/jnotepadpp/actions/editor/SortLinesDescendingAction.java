...
/**
 * SortLinesDescendingAction extends {@link LocalizableAction} for sorting text
 * lines descending.
 * 
 * @author Filip Gulan.
 * @version 1.0
 *
 */
public class SortLinesDescendingAction extends LocalizableAction {
    ...
    /**
     * Constructor for SortLinesDescendingAction action class.
     * 
     * @param key
     *            Localization key.
     * @param lp
     ...
     *            Main JNotepadPP frame.
     */
    public SortLinesDescendingAction(String key, ILocalizationProvider lp,
            JNotepadPP observer) {
        super(key, lp);
